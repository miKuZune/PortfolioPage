class Manager
{
    Init()
    {
        ...
        console.log('hello');
        console.log((this.container.offsetHeight * 0.8) / 2);
        this.areaStartPos = (this.container.offsetWidth * 0.8) + 150;

        ctx.canvas.width = this.container.offsetWidth * 0.8;
        // ctx.canvas.height = this.container.offsetHeight;
    ...
    Run(canvasID)
    {
        ...
        this.container = document.getElementById('A_Star');
        ...
        setInterval(function()
        {
            ...
            ctx.fillRect(0,0,this.container.offsetWidth,this.container.offsetHeight);
